...
5. An expression is non-executable if under its intended reading it denies a condition constitutive of its own truth-conditions. It parses. Its truth-conditions cannot be fixed.
...
The criterion is general: an expression e is non-executable if under its intended reading, e denies a condition that is constitutive of e's having determinate truth-conditions at all. This is a semantic criterion, not a pragmatic one. The question is not whether the act of checking e requires something e denies — almost any globally quantified denial would meet that test, since someone is always doing the checking. The question is whether e's truth-conditions can be fixed without presupposing what e negates.

"There are no tables" has truth-conditions that do not require tables: it is true if the domain contains no tables, false otherwise. Evaluation does not require tables. The sentence is evaluable. "There are no living things anywhere" also has truth-conditions that do not require living things: it is true if the domain contains no living things, false otherwise. A living thing checking it is a counterexample, not a precondition failure — the sentence is simply false. The act of checking requires a living thing, but the sentence's truth-conditions do not. It is executable. It returns false.

"Nothing exists" on the absolute reading is different. It is not a first-order claim within a fixed semantics — it is a totalizing cancellation of the semantic preconditions that would make it a first-order claim at all. There is no domain relative to which it could be true, because it denies domains. There is no satisfaction relation it could fail, because it denies satisfaction relations. Its truth-conditions cannot be stated without presupposing the structure it negates. This is what makes it non-executable rather than merely false. The expression does not return a negative verdict. It fails to reach the evaluation procedure at all.

"This statement is false" denies the stability of the truth predicate required for its own truth-conditions to be determinate — the content refers only to itself with no base case, so no fixed truth-condition can be assigned. {P, ¬P} denies the consistency required for evaluation to resolve into a determinate output — the truth-conditions of P and ¬P jointly cannot be satisfied. In each case, the expression is syntactically well-formed — it passes the grammar — but the truth-conditions it requires cannot be fixed because the expression negates a condition constitutive of their determinacy.

"Denies" is precise throughout: under the intended reading of e, the expression asserts or entails the negation of a condition that is constitutive of e's having truth-conditions at all. "There are no tables" does not deny a condition constitutive of its own truth-conditions. "Nothing exists" on the absolute reading does. The criterion does not overgenerate because it operates at the level of semantic determinacy, not at the level of who happens to be checking.

For globally quantified denials — "nothing," "nowhere," "no structure whatsoever" — the relevant scope is necessarily global: any admissible local context in which the expression could be evaluated would itself falsify the claim's intended scope. There is no "other evaluation context" to retreat to, because the claim denies all of them.
